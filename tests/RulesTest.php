...
class RulesTest extends TestCase
{
    ...
    {
        $foundRegistrableDomain = $this->rules->resolve($domain, Rules::ICANN_DOMAINS)->getRegistrableDomain();
    ...
    {
        $effectiveTLD = $this->rules->resolve($domain, Rules::ICANN_DOMAINS)->getPublicSuffix();
